This simple application gets the public pages from LinkedIn and create the user in the database
including name, current position, current title, education and skills.
